/******************************************************************************
 *  Compilation:  javac UltraDraw.java
 *  Execution:    java UltraDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code UltraDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code UltraDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/UltraDraw.java">UltraDraw.java</a>
 *  and put a copy in your working directory.
 *  <p>
 *  Now, type the following short program into your editor:
 *  <pre>
 *   public class TestUltraDraw {
 *       public static void main(String[] args) {
 *           UltraDraw.setPenRadius(0.05);
 *           UltraDraw.setPenColor(UltraDraw.BLUE);
 *           UltraDraw.point(0.5, 0.5);
 *           UltraDraw.setPenColor(UltraDraw.MAGENTA);
 *           UltraDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code UltraDraw.line()} and {@code UltraDraw.point()}
 *  draw lines and points; the methods {@code UltraDraw.setPenRadius()}
 *  and {@code UltraDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code UltraDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *  </ul>
 *  <p>
 *  For example, {@code UltraDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code UltraDraw.setPenColor(UltraDraw.MAGENTA)} sets the
 ...
 *  For example, {@code UltraDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code UltraDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   UltraDraw.setFont(font);
 *   UltraDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code UltraDraw.clear(UltraDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   UltraDraw.setScale(-2, +2);
 *   UltraDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       UltraDraw.clear();
 *       UltraDraw.filledCircle(x, y, 0.05);
 *       UltraDraw.filledCircle(-x, -y, 0.05);
 *       UltraDraw.show();
 *       UltraDraw.pause(20);
 *   }
...
public final class UltraDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    ***************************************************************************/
     ...
     * {@code UltraDraw.BLACK}, {@code UltraDraw.BLUE}, {@code UltraDraw.CYAN},
     * {@code UltraDraw.DARK_GRAY}, {@code UltraDraw.GRAY}, {@code UltraDraw.GREEN},
     * {@code UltraDraw.LIGHT_GRAY}, {@code UltraDraw.MAGENTA}, {@code UltraDraw.ORANGE},
     * {@code UltraDraw.PINK}, {@code UltraDraw.RED}, {@code UltraDraw.WHITE}, and
     * {@code UltraDraw.YELLOW}.
     *
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to UltraDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
*/
    ...
    *  as an argument. It can handle action keys
     ...
     */
    public static void main(String[] args) {
        UltraDraw.square(0.2, 0.8, 0.1);
        UltraDraw.filledSquare(0.8, 0.8, 0.2);
        UltraDraw.circle(0.8, 0.2, 0.2);

        UltraDraw.setPenColor(UltraDraw.BOOK_RED);
        UltraDraw.setPenRadius(0.02);
        UltraDraw.arc(0.8, 0.2, 0.1, 200, 45);
